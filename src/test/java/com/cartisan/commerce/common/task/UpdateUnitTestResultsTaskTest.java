package com.cartisan.commerce.common.task;
...
public class UpdateUnitTestResultsTaskTest {
    ...
    private final String testResultFileNamePattern = "TEST-com.cartisan.commerce.transaction.controller.%s.xml";
    private BuildResult result;
    private String sourceTestResultsFolder;
    private final String defaultXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
            "<testsuite name=\"com.cartisan.commerce.RequireMergeTest$SubClass\" tests=\"1\" skipped=\"0\" failures=\"0\" errors=\"0\" timestamp=\"2016-11-06T10:32:48\" hostname=\"zhangjinhuadeMacBook-Pro\" time=\"0.41\">\n" +
            "   <properties/>\n" +
            "   <testcase name=\"should_not_add_account\" classname=\"com.cartisan.commerce.account.controller.AccountAddControllerTest\" time=\"0.041\"/>\n" +
            "   <system-out><![CDATA[]]></system-out>\n" +
            "   <system-err><![CDATA[]]></system-err>\n" +
            "</testsuite>";
    private String defaultClassName = "com.cartisan.commerce.RequireMergeTest$SubClass";
    ...
    public void should_create_a_new_test_result_file_with_same_content_of_nested_runner_result() throws IOException, ParserConfigurationException, SAXException {
        ...
        assertTaskRunSuccess();
        assertXmlFileAttributeChanged("com.cartisan.commerce.RequireMergeTest", "name", "RequireMergeTest$SubClass");
    }
